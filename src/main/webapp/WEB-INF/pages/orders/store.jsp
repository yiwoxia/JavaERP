...
function openUpdateDialog() {
	...
	url = "${ctx}/store_updateStore.action";
	$('#form').form("load", row);
}
...
<body>
	...
	<div id="toolbar">
		...
		&nbsp;&nbsp;&nbsp;&nbsp; -->
		<div>
		      仓库名称：<input style="width: 100px;" type="text" id="nameSearch"></input>
		      仓库管理员：<input style="width: 100px;" type="text" id="personSearch"></input>
